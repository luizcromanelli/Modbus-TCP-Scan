...
### 📦 Download
* Direct Link: [**Download ModbusScan_v1.8.exe**](https://github.com/luizcromanelli/Modbus-TCP-Scan/releases/download/1.8/ModbusScan_v1.8.zip)
...
Modbus TCP Scan is a completely free tool (Free), developed in Python using pyModbusTCP. The software was severely optimized and structured with data validation masks and an intelligent state machine for fault handling, ensuring absolute stability in harsh and unpredictable industrial environments.
...
* **Supported Modbus Functions:**
  ...
  * FC 05 - Write Single Coil (0X)
  * FC 06 - Write Single Holding Register (4X)
...
1. Click here for [**Direct Download of ModbusScan_v1.8.exe**](https://github.com/luizcromanelli/Modbus-TCP-Scan/releases/download/1.8/ModbusScan_v1.8.zip).
...
* **Method 2 (In the file properties):** Before opening, right-click on the downloaded `ModbusScan_v1.8.exe` file, go to **Properties**, check the **"Unblock"** checkbox located at the bottom of the General tab, and click Apply/OK.
...
### 📦 Download
* Link Direto: [**Baixar ModbusScan_v1.8.exe**](https://github.com/luizcromanelli/Modbus-TCP-Scan/releases/download/1.8/ModbusScan_v1.8.zip)
...
O Modbus TCP Scan é uma ferramenta totalmente gratuita (Free), desenvolvida em Python utilizando pyModbusTCP. O software foi severamente otimizado e estruturado com máscaras de validação de dados e uma máquina de estados inteligente para tratamento de falhas, garantindo estabilidade absoluta em ambientes industriais hostis e imprevisíveis.
...
### 💎 Por que escolher o Modbus TCP Scan?
...
1. Clique aqui para fazer o [**Download Direto do ModbusScan_v1.8.exe**](https://github.com/luizcromanelli/Modbus-TCP-Scan/releases/download/1.8/ModbusScan_v1.8.zip).
...
* **Método 2 (Nas propriedades do arquivo):** Antes de abrir, clique com o botão direito sobre o arquivo ModbusScan_v1.8.exe baixado, vá em Propriedades, marque a caixa de seleção "Desbloquear" (Unblock) localizada na parte inferior da aba Geral e clique em Aplicar/OK.
